...
struct Statistics {
    ...
    int points;
    /* Indica i punti esperienza dell'entità e corrisponde alla quantità di punti che il giocatore possiede o che può guadagnare 
...
protected:
    ...
    attacchi, la velocità dei proiettili e la gittata dei proiettili. */
    Room room;
};
